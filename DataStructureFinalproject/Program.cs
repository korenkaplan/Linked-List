...
========================";
        ...
        {
            // paste here the region "Syntax For Validation in main" of the question you want to check , its found inside the question's region at the bottom (Q13 - Q25) and remove the comments from inside. 
        ...
        static void Main(string[] args)
        {
           ...
           -------------------------------------------------------------------------------
            ...
            1.Unfold the region "Check a Specific Function"
            ...
            4.Remove the comoments signs inside the region
            5. Run the Code
           -------------------------------------------------------------------------------
            */
        #region Check a Specific Function 
            if (false) // True --> checking specific function, False --> run the full script 
            {
        ...
        #region Init Parameters
           // int cmSpeed = 10, codeSpeed = 10, otSpeed = 10; // fast testing mode
